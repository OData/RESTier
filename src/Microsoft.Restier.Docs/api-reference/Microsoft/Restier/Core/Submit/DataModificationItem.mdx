...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  ActualResourceType <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  ChangeSetItemProcessingStage <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  EntitySetOperation <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  ExpectedResourceType <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  IsFullReplaceUpdateRequest <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  LocalValues <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  OriginalValues <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  Resource
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  Resource <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  ResourceKey <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  ResourceSetName <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  ServerValues <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  Type <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="function" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  ApplyTo <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="function" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  HasChanged <DocsBadge text="Inherited" variant="neutral" />
...
### <Icon icon="function" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  ValidateEtag <DocsBadge text="Inherited" variant="neutral" />
