...
### <Icon icon="puzzle-piece" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> GenerateVisibilityMatrix <Badge color="green">Extension</Badge>
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> WriteCurrentVisibilityMatrix <Badge color="green">Extension</Badge>
