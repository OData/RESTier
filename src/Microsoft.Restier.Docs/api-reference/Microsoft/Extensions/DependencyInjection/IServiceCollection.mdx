...
### <Icon icon="puzzle-piece" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> AddRestier <Badge color="green">Extension</Badge>
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> AddRestierSwagger <Badge color="green">Extension</Badge>
