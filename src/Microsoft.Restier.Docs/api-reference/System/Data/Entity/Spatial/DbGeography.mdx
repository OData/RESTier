...
### <Icon icon="puzzle-piece" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  ToGeographyLineString <DocsBadge text="Extension" variant="success" />
...
### <Icon icon="puzzle-piece" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  ToGeographyPoint <DocsBadge text="Extension" variant="success" />
