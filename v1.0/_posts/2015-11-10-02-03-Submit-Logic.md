...
Customize submit logic with single class for all entity set is also supported, refer to [section 2.9](http://odata.github.io/RESTier/v0.6/#02-09-Customize-Submit) for more detail.
