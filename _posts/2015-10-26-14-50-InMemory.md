---
layout: post
title: "3.6 In-Memory Provider [>=0.4.0-rc]"
description: ""
...
First please create an **Empty ASP.NET Web API** project following the instructions in [1.4](http://odata.github.io/RESTier/#11-40-Bootstrap). Stop **BEFORE** the **Generate the model classes** part.
